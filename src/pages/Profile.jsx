...
import { collection, doc,getDocs, updateDoc, query,orderBy,where, deleteDoc } from 'firebase/firestore';
...
export default function Profile() {
  ...
  return (
    <>
      <section className='msx-w-6xl mx-auto flex
      justify-center items-center flex-col'>
      <h1 className='text-3xl text-center mt-6 font-bold uppercase'> My Profile</h1>
      <div className='w-full md:w-[50%] mt-6 px-3'> 
        <form> 
          {/* name input */}
          <input type='text' id='name' value={name} disabled ={!changeDetail}
          onChange={onChange}
          className={`mb-6 w-full px-4 py-2 text-xl text-gray-600 bg-white 
          ...
          whitespace-nowrap text-sm sm:text-lg '> 
            ...
            <p onClick={onLogout} className='text-blue-500 hover:text-blue-800
        ...
        uppercase px-7 py-3 text-lg font-medium rounded shadow-md 
        hover:bg-blue-600 transition duration-150 ease-in-out 
        hover:shadow-lg active: bg-blue-400'>
          <Link to="/create-listing" className='flex justify-center
          items-center' > 
             <FcHome  className='mr-2 text-4xl bg-red-200 
